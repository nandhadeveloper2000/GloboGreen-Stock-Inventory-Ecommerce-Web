              ...
              <div className="relative flex items-center bg-white/75 p-6 backdrop-blur-xl sm:p-8 lg:p-10">
                <div className="mx-auto w-full max-w-xl">
                  ...
                  <div className="grid gap-5">
                    <Link
                      href="/masterlogin"
                      className="group relative overflow-hidden rounded-card border border-border/70 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:shadow-[0_20px_50px_rgba(15,23,42,0.12)]"
                    >
