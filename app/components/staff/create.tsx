  ...
  return (
    <label
      ...
      className={classNames(
        "pointer-events-none absolute left-3 top-1.5 z-10 max-w-[calc(100%-1.5rem)] truncate bg-white px-1 text-[11px] font-medium leading-none",
    ...
    <div className="min-w-0 space-y-1.5">
      <div className="relative min-w-0">
        ...
        <input
          ...
          className={classNames(
            "h-11 w-full min-w-0 rounded-xl border bg-white px-3.5 pb-2 pt-5 text-sm font-normal text-slate-900 shadow-sm outline-none transition placeholder:font-normal placeholder:text-slate-400/80",
            error
      ...
      {error ? (
        <p className="px-1 text-xs font-semibold text-rose-500">{error}</p>
      ) : null}
    </div>
  );
}
    ...
    <div className="min-w-0 space-y-1.5">
      <div className="relative min-w-0">
        ...
        <select
          ...
          disabled={disabled}
          className={classNames(
            "h-11 w-full min-w-0 appearance-none rounded-xl border bg-white px-3.5 pb-2 pt-5 pr-10 text-sm font-normal text-slate-900 shadow-sm outline-none transition",
            error
              ? "border-rose-300 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10"
              : "border-slate-200 focus:border-[#00008b] focus:ring-4 focus:ring-[#00008b]/10",
            disabled && "cursor-not-allowed bg-slate-50 text-slate-400"
...
function SearchableSelect({
  ...
  return (
    <div ref={containerRef} className="min-w-0 space-y-1.5">
      <div className="relative min-w-0">
        <FieldLabel
          htmlFor={id}
          label={label}
        ...
        <button
          ...
          className={classNames(
            "flex h-11 w-full min-w-0 items-center justify-between rounded-xl border bg-white px-3.5 pb-2 pt-5 text-left text-sm font-normal shadow-sm outline-none transition",
            error
              ? "border-rose-300 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10"
              : "border-slate-200 focus:border-[#00008b] focus:ring-4 focus:ring-[#00008b]/10",
            disabled && "cursor-not-allowed bg-slate-50 text-slate-400"
        ...
        {open ? (
          <div className="absolute left-0 right-0 top-[calc(100%+0.5rem)] z-100 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-[0_16px_36px_rgba(15,23,42,0.14)]">
            <div className="border-b border-slate-100 p-2.5">
              <div className="relative">
                ...
                <input
                  ...
                  className="h-10 w-full rounded-lg border border-slate-200 bg-slate-50 pl-10 pr-3 text-sm text-slate-900 outline-none placeholder:text-slate-400 focus:border-[#00008b] focus:bg-white focus:ring-2 focus:ring-[#00008b]/10"
                />
              </div>
            ...
            <div className="max-h-56 overflow-y-auto p-2">
              {canCreate ? (
                <button
                  ...
                  className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-left text-sm font-bold text-[#00008b] transition hover:bg-[#00008b]/10"
                >
                  ...
                  return (
                    <button
                      ...
                      className={classNames(
                        ...
                        selected
                          ? "bg-[#00008b]/10 font-bold text-[#00008b]"
    ...
    <div className="rounded-xl border border-slate-200 bg-white p-3.5">
      ...
      <div className="mt-3">
        {preview ? (
          ...
          <div className="flex h-28 w-full items-center justify-center rounded-xl border border-dashed border-slate-300 bg-slate-50 text-slate-400">
            {emptyIcon}
          </div>
        )}
        ...
        <div className="mt-3 grid grid-cols-1 gap-2">
          <button
            ...
            className="inline-flex h-10 w-full items-center justify-center rounded-xl bg-[#00008b] px-3.5 text-sm font-black text-white transition hover:bg-[#000070]"
          >
            {buttonLabel}
          </button>
          ...
          {preview ? (
            <button
              type="button"
              onClick={onRemove}
              className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-xl border border-rose-200 bg-white px-3.5 text-sm font-bold text-rose-600 transition hover:bg-rose-50"
            >
              <X className="h-4 w-4" />
              Remove
            </button>
...
export default function CreateStaffPage({
  ...
  const fetchAreas = async () => {
    ...
    if (!data.length) data = await fetchApi(fallbackUrl);
  ...
  if (loadingStaff) {
    return (
      <div className={pageShellClass}>
        <div className="mx-auto flex w-full max-w-5xl items-center justify-center rounded-[18px] border border-slate-200 bg-white py-14 shadow-[0_18px_55px_rgba(15,23,42,0.08)]">
          <div className="flex items-center gap-3 text-slate-700">
            <Loader2 className="h-5 w-5 animate-spin text-[#00008b]" />
            <span className="text-sm font-black">Loading staff details...</span>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className={pageShellClass}>
      <div className={asModal ? "w-full" : "mx-auto w-full max-w-6xl"}>
        <form
          onSubmit={handleSubmit}
          className={
            asModal
              ? "flex max-h-[calc(100vh-3rem)] flex-col overflow-hidden rounded-[18px] bg-white"
              : "flex max-h-[calc(100vh-7rem)] flex-col overflow-hidden rounded-[18px] border border-slate-200 bg-white shadow-[0_18px_55px_rgba(15,23,42,0.08)]"
          }
        >
          {asModal ? (
            <div className="sticky top-0 z-20 flex shrink-0 items-center justify-between border-b border-slate-200 bg-white px-4 py-3 sm:px-5">
              <h2 className="min-w-0 truncate text-base font-black text-slate-950">
                {pageTitle}
              </h2>
              ...
              <button
                ...
                title="Close"
                aria-label="Close"
                className="ml-3 inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-600 transition hover:border-rose-200 hover:bg-rose-50 hover:text-rose-600 disabled:cursor-not-allowed disabled:opacity-60"
              >
                <X className="h-4 w-4" />
              </button>
            </div>
            ...
            <div className="shrink-0 border-b border-slate-200 bg-white px-4 py-4 sm:px-5">
              <button
                ...
                onClick={handleCancel}
                disabled={submitting || loadingStaff}
                className="mb-4 inline-flex h-10 w-fit items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-3 text-sm font-bold text-slate-700 transition hover:border-[#00008b] hover:bg-[#00008b]/5 hover:text-[#00008b] disabled:cursor-not-allowed disabled:opacity-60"
              >
                  ...
                  <section className="rounded-[18px] border border-slate-200 bg-white p-4">
                    ...
                    <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                      <FloatingSelect
                        ...
                        value={form.role}
                        onChange={(event) =>
                          updateField("role", event.target.value as CreateRole)
                        }
                      ...
                      <FloatingInput
                        ...
                        value={form.name}
                        onChange={(event) =>
                          updateField("name", alphaSpaceOnly(event.target.value))
                        }
                        error={errors.name}
                        required
                      />
                      ...
                      <div className="md:col-span-2">
                        <div className="grid grid-cols-1 gap-3 md:grid-cols-[minmax(0,1fr)_150px]">
                          ...
                          <button
                            ...
                            disabled={submitting}
                            className="inline-flex h-11 items-center justify-center rounded-xl bg-[#00008b] px-4 text-sm font-black text-white transition hover:bg-[#000070] disabled:cursor-not-allowed disabled:opacity-60"
                          >
                            Auto Generate
                          </button>
                        </div>
                  ...
                  <section className="rounded-[18px] border border-slate-200 bg-white p-4">
                    ...
                    <div className="space-y-3">
                      <UploadPreviewCard
                        ...
                        previewClassName="h-28 w-full rounded-xl border border-slate-200 object-cover shadow-sm"
                      />

                      <UploadPreviewCard
                        title="ID Proof"
                        description="ID proof image"
          ...
          <div className="shrink-0 border-t border-slate-200 bg-white px-4 py-3 sm:px-5">
            <div className="flex flex-col-reverse gap-2 sm:flex-row sm:items-center sm:justify-end">
              <button
                ...
                onClick={handleCancel}
                disabled={submitting || loadingStaff}
                className="inline-flex h-10 items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-4 text-sm font-black text-slate-700 transition hover:border-[#00008b] hover:bg-[#00008b]/5 hover:text-[#00008b] disabled:cursor-not-allowed disabled:opacity-60"
              >
                <ArrowLeft className="h-4 w-4" />
                Cancel
              </button>
              ...
              <button
                type="submit"
                disabled={
                  submitting || isLocationLoading || allowedRoles.length === 0
                }
