      ...
      <div className="page-shell">
        <div className="admin-list-frame">
          <section className="admin-list-hero">
            <div className="admin-list-hero-body">
              <div className="admin-list-hero-row">
                <div className="min-w-0">
                  ...
                  <h1 className="admin-list-title mt-3 truncate">
                    {getPageTitle(currentRole)}
                  </h1>
                  <p className="admin-list-description font-semibold">
            ...
            <div className="grid gap-3 px-4 py-4 sm:grid-cols-3 sm:px-5 md:px-6">
          ...
          <section className="admin-list-card">
            <div className="admin-list-card-header">
              ...
              <div className="admin-list-search-row">
                <div className="admin-list-search-wrap lg:max-w-sm">
        ...
        {staffModal ? (
          ...
          >
            <div className="relative my-2 w-full max-w-6xl overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-2xl">
              <CreateStaffPage
