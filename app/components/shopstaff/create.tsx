  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch(
        `${baseURL}${SummaryApi.shopstaff_create.url}`,
        {
          method: SummaryApi.shopstaff_create.method,
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
          body: payload,
      ...
      if (!response.ok || !result?.success) {
        toast.error(result?.message || "Failed to create shop staff");
        return;
      }
          ...
          <div className="relative z-10 grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_340px]">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-sm leading-6 text-white/80 md:text-base">
                Add a new shop team member with role, contact, address, avatar,
                and ID proof in one single form.
              </p>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 lg:grid-cols-1">
              ...
              <InfoPill
                label="Selected Shop"
                value={selectedShopName || "Not Selected"}
              />
            </div>
          </div>
        </section>
            ...
            <div className="space-y-5">
              <div className="rounded-[30px] border border-slate-200 bg-white p-5 shadow-[0_18px_50px_rgba(15,23,42,0.08)] md:p-6">
                <SectionHeader
                  ...
                  description="Enter the core account details for the shop staff member."
                />
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div className="md:col-span-2 grid grid-cols-1 gap-4 md:grid-cols-[minmax(0,1fr)_170px]">
                    <FloatingInput
                      id="username"
                      label="Username"
                      value={form.username}
                    ...
                    <button
                      ...
                      className="inline-flex h-14 items-center justify-center gap-2 rounded-2xl border border-violet-200 bg-violet-50 px-4 text-sm font-semibold text-violet-700 transition hover:bg-violet-100"
                    >
            ...
            <div className="space-y-5">
              <div className="rounded-[30px] border border-slate-200 bg-white p-5 shadow-[0_18px_50px_rgba(15,23,42,0.08)] md:p-6">
                <SectionHeader
                  ...
                  title="Uploads"
                  description="Upload avatar and ID proof images."
                />
