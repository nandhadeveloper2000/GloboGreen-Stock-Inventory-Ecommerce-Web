...
export default function MyBrandEditPage({
  mapId,
  isModal = false,
  onClose,
  onSuccess,
  ...
  async function handleSubmit() {
    if (!id) {
      toast.error("Invalid brand mapping id");
      return;
    }
    ...
    try {
      ...
      const api = SummaryApi.shopBrandMapUpdate;
            ...
            <div className="relative z-10 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-white/80">
                  Update shop brand mapping status.
                </p>
              </div>
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-xs font-medium text-slate-500">
                      Inactive brand will not be available in model and product
                      mapping.
                    </p>
                  </div>
