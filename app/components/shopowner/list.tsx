...
import { ShopOwnerForm } from "./create";
import { ShopOwnerViewModal } from "./view";
...
export default function ShopOwnerListPage() {
  ...
  const panelBasePath = currentRole === "MANAGER"
    ? "/manager/shopowner"
    : currentRole === "SUPERVISOR"
    ? "/supervisor/shopowner"
    : currentRole === "STAFF"
    ? "/staff/shopowner"
    : "/master/shopowner";
    ...
    <div className="page-shell">
      <div className="mx-auto w-full max-w-9xl">
          ...
          <div className="border-b border-slate-100 px-4 py-4 sm:px-5 md:px-6">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                ...
                <button
                  type="button"
                  onClick={() => router.push(`${panelBasePath}/create`)}
        ...
        {editingId ? (
          <ShopOwnerForm
            mode="edit"
            shopOwnerId={editingId}
            asModal
            onClose={() => setEditingId("")}
            onSaved={fetchShopOwners}
          />
        ) : null}
      </div>
    </div>
