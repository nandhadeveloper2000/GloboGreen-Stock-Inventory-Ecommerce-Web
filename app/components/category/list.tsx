...
function CategoryImage({ item, size = 52 }: { item: CategoryItem; size?: number }) {
          ...
          <div className="border-b border-slate-100 px-4 py-4 sm:px-5 md:px-6">
              ...
              <div className="min-w-0 space-y-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-slate-500">
                    All Categories in your system are listed here. You can search, filter, edit, or delete any category.
                  </p>
                </div>
              </div>
            ...
            <div className="mt-4 flex flex-col gap-3 lg:flex-row lg:items-center">
              <div className="relative flex-1">
                ...
                <input
                  type="text"
                  placeholder="Search by category name, name key, or master category"
                  value={search}
                    ...
                    paginatedItems.map((item, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-4 py-4">
                            <span className="inline-flex items-center gap-2 rounded-full border border-[#00008b]/10 bg-[#00008b]/5 px-2.5 py-1 text-xs font-black text-[#00008b]">
