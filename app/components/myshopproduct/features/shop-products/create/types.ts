...
export type NamedReference =
  ...
  | {
      ...
      name?: string;
      nameKey?: string;
      masterCategoryId?: NamedReference;
...
export type ProductCatalogItem = {
  ...
  brandId?: NamedReference | NamedReference[];
  modelId?: NamedReference | NamedReference[];
  images?: MediaAsset[];
  variant?: ProductVariantDefinition[];
};

export type ShopCategoryMapItem = {
  _id: string;
  isActive?: boolean;
  masterCategoryId?: NamedReference;
  categoryId?: NamedReference;
  category?: NamedReference;
  masterCategory?: NamedReference;
};

export type ShopSubCategoryMapItem = {
  _id: string;
  isActive?: boolean;
  subCategoryId?: NamedReference;
};

export type ShopBrandMapItem = {
  _id: string;
  isActive?: boolean;
  brandId?: NamedReference;
};

export type ShopModelMapItem = {
  _id: string;
  isActive?: boolean;
