    ...
    try {
      ...
      const url =
        typeof api.url === "function"
          ? api.url(currentShopId)
          : `/api/shop-category-maps/shop/${currentShopId}`;
          ...
          <div className="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm font-medium text-white/85">
                Manage categories mapped to {shopName}.
              </p>
            </div>

            <button
              type="button"
              onClick={() => router.push("/shopowner/my-category/create")}
          ...
          {loading ? (
            ...
            <div className="flex min-h-65 flex-col items-center justify-center px-4 text-center">
              ...
              <p className="mt-1 max-w-md text-sm font-medium text-slate-500">
                Add categories to show shop-specific products.
              </p>
            </div>
          ) : (
                        ...
                        <td className="px-4 py-3 text-right">
                          <div className="flex justify-end gap-2">
                            <button
                              ...
                              onClick={() =>
                                router.push(
                                  `/shopowner/my-category/view?id=${row._id}`
                                )
                              }
                            ...
                            <button
                              ...
                              onClick={() =>
                                router.push(
                                  `/shopowner/my-category/edit/${row._id}`
                                )
                              }
