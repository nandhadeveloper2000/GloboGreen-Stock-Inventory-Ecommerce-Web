...
function BrandImageBox({ item, size = 52 }: { item: BrandItem; size?: number }) {
  ...
  return (
    <div className="page-shell">
          ...
          <div className="border-b border-slate-100 px-4 py-4 sm:px-5 md:px-6">
              ...
              <div className="min-w-0 space-y-3">
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-slate-500">
                    All Brands in your system are listed here. You can search,
                    filter, edit, or delete any brand.
                  </p>
                </div>
              </div>
            ...
            <div className="mt-4 flex flex-col gap-3 lg:flex-row lg:items-center">
              <div className="relative flex-1">
                ...
                <input
                  type="text"
                  placeholder="Search by brand name or name key"
                  value={search}
                    ...
                    paginatedItems.map((item, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-4 py-4">
                            <BrandImageBox item={item} size={52} />
                          </td>
                          ...
                          <td className="px-4 py-4">
                            <span className="inline-flex max-w-45 items-center rounded-full border border-[#00008b]/10 bg-[#00008b]/5 px-2.5 py-1 text-xs font-black text-[#00008b]">
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <BrandImageBox item={item} size={56} />
      ...
      {modalState.open ? (
        ...
        >
          <div
            className="relative w-full max-w-5xl overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-2xl"
