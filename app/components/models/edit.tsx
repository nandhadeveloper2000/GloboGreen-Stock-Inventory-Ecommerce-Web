...
export default function MyModelEditPage({
  mapId,
  isModal = false,
  onClose,
  onSuccess,
  ...
  async function handleSubmit() {
    if (!id) {
      toast.error("Invalid model mapping id");
      return;
    }
    ...
    try {
      ...
      const api = SummaryApi.shopModelMapUpdate;
      ...
      router.push("/shopowner/models/list");
    } catch (error) {
      toast.error(getApiErrorMessage(error, "Failed to update model"));
    } finally {
      setSaving(false);
    }
  }
            ...
            <div className="relative z-10 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-white/80">
                  Update shop model mapping status.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-[220px_1fr]">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                <Info label="Model" value={model?.name || "-"} />
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-xs font-medium text-slate-500">
                      Inactive model will not be available in shop product
                      mapping.
                    </p>
                  </div>
