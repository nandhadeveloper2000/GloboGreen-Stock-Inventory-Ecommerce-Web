  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-100 p-4 md:p-6">
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <section className="relative overflow-hidden rounded-[28px] bg-gradient-to-r from-indigo-700 via-violet-700 to-fuchsia-600 px-6 py-7 text-white shadow-[0_20px_60px_rgba(91,33,182,0.28)] md:px-8">
        ...
        <section className="rounded-[28px] border border-slate-200 bg-white shadow-sm">
          <div className="flex flex-col gap-4 border-b border-slate-200 p-4 md:flex-row md:items-center md:justify-between md:p-5">
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-700 to-fuchsia-600 text-white shadow-sm">
                <Boxes className="h-5 w-5" />
              </div>
            ...
            <div className="relative w-full md:max-w-sm">
              ...
              <input
                ...
                className="h-11 w-full rounded-2xl border border-slate-300 bg-slate-50 pl-10 pr-4 text-sm text-slate-700 outline-none transition focus:border-violet-500 focus:bg-white focus:ring-4 focus:ring-violet-100"
              />
            </div>
          </div>
...
<td className="px-4 py-4">
  <div className="flex flex-wrap items-center justify-end gap-3">
    ...
    <button
      ...
      className={`inline-flex h-10 min-w-[130px] items-center justify-center gap-2 rounded-2xl border px-4 text-sm font-semibold transition
        ${
          isActive
    ...
    <button
      ...
      className="inline-flex h-10 min-w-[95px] items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 text-sm font-semibold text-slate-700 transition hover:bg-slate-50"
    >
    ...
    <button
      ...
      className="inline-flex h-10 min-w-[105px] items-center justify-center gap-2 rounded-2xl border border-rose-200 bg-rose-50 px-4 text-sm font-semibold text-rose-600 transition hover:bg-rose-100 disabled:cursor-not-allowed disabled:opacity-70"
    >
