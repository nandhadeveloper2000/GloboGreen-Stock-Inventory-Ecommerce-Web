...
export default function CreateModelPage({
  ...
  const nameKeyPreview = useMemo(() => normalizeKey(name), [name]);
                ...
                <div className="grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
                  <div className="space-y-5">
                    ...
                    <div ref={brandDropdownRef} className="relative">
                      <button
                        type="button"
                        disabled={brandsLoading || disabled}
                        onClick={() => {
                          if (brandsLoading || disabled) return;
                    ...
                    <button
                      ...
                      disabled={brandsLoading || disabled}
                      className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-4 text-sm font-bold text-slate-700 transition hover:border-[#00008b] hover:bg-[#00008b]/5 hover:text-[#00008b] disabled:cursor-not-allowed disabled:opacity-60 sm:w-fit"
                    >
                      <RefreshCw
                        className={`h-4 w-4 ${
                  ...
                  <aside className="rounded-3xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <PreviewRow
                        label="Model Name"
                        value={name.trim() || "Enter model name"}
                      />
