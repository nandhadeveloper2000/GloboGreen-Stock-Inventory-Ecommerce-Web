    ...
    <div className="min-h-screen bg-slate-50 px-3 py-7 sm:px-5 lg:px-8">
            ...
            <>
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {paginatedRows.map((customer, index) => (
                      ...
                      >
                        ...
                        <td className="px-3 py-3">
                          <div className="min-w-52.5 space-y-1.5 text-xs font-semibold text-slate-600">
                        ...
                        <td className="px-3 py-3">
                          <div className="min-w-37.5 space-y-1 text-xs text-slate-600">
                        ...
                        <td className="px-3 py-3">
                          <div className="flex max-w-57.5 items-start gap-2 text-xs font-semibold text-slate-600">
              ...
              <div className="flex flex-col gap-3 border-t border-slate-200 bg-white px-4 py-3 text-sm sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex flex-wrap items-center gap-3 sm:justify-end">
                  ...
                  <span className="min-w-13.5 text-center text-sm font-black text-slate-700">
                    {currentPage} / {maxPage}
                  </span>
      ...
      {modalOpen ? (
        <div
          ...
          aria-modal="true"
        >
          <div className="max-h-[94vh] w-full max-w-5xl overflow-y-auto rounded-card border border-slate-200 bg-white shadow-[0_24px_80px_rgba(15,23,42,0.25)]">
